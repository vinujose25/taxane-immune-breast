...
# 4. Validation of processed gene modules (Full to subset correlation)
# 5. Save R objects
...
# Ref: in house project "expr_tcga-expr_metabric-metagxbreast" (https://osf.io/jb8za/)
...
# 2. Load and clean original gene-modules.
# ==============================================================================
...
#   and Module sub-setting according to finher and neoadj genes
# ==============================================================================


# Module geneset agreement plot
...
pdf(file = str_c(out_figures,"Module_pub_original_gene_overlap_proportion.pdf"),
    width = 5.5, height = 6)
print(
  p_agreement +
...
pdf(file = str_c(out_figures,"Module_pub_original_correlation_metabric.pdf"),
    width = 5.5, height = 6)
print(
  p_correlation +
    theme(plot.title.position = "plot",
...
pdf(file = str_c(out_figures,"Module_pub_original_correlation_tcga.pdf"),
    width = 5.5, height = 6)
print(
  p_correlation +
    theme(plot.title.position = "plot",
...
#
# write_xlsx(x = lst,
#            path = str_c(out_data, "Module_list.xlsx")
# )
#
#
#
...
#
# write_xlsx(x = lst,
#            path = str_c(out_data, "Module_validation_statistics.xlsx")
# )
#
#
# #
...
rm(
  ...
  tcga, metabric,
  expr_tcga, expr_metabric,
  module_consolidated, module_size_selected, module_size_filter,
  module_list, module_list_finneo, module_list_neo,
  module_list_sizecor_selected_finneo, module_list_sizecor_selected_neo,
  validation_finneo_expr_tcga, validation_finneo_expr_metabric, validation_finneo_stat,
  validation_neo_expr_tcga, validation_neo_expr_metabric, validation_neo_stat
)
