...
# 1 FALSE FALSE FALSE TRUE  TRUE    TRUE  TRUE      5
# 2 FALSE TRUE  FALSE TRUE  TRUE    TRUE  TRUE     71
# 3 TRUE  FALSE FALSE FALSE TRUE    TRUE  TRUE      2
# 4 TRUE  FALSE FALSE TRUE  TRUE    TRUE  TRUE    229
# 5 TRUE  FALSE TRUE  FALSE TRUE    TRUE  TRUE      1
# 6 TRUE  FALSE TRUE  TRUE  TRUE    TRUE  TRUE     88
# 7 TRUE  TRUE  FALSE FALSE TRUE    TRUE  TRUE    154
# 8 TRUE  TRUE  FALSE TRUE  TRUE    TRUE  TRUE     63
# 9 TRUE  TRUE  TRUE  TRUE  TRUE    TRUE  TRUE   1075


xsum$N %>% sum() # 1688; 1688 - 1075 = 613
# !!!!!!!!!!!!!!!!!!!
# 1075 samples got all relevant clinical-pathological variables
...
xsum <-clin_neoadj %>%
  ...
  dplyr::summarise(N = n(), .groups = "keep")
#   Subtype Arm   pCR       N
# 1 TRUE    TRUE  TRUE   1688

# !!!!!!!!!!!!!!!!!!!
# 1688 samples got all subtype, arm and pCR data
