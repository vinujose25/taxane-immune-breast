...
finher_her2[["inter.chemo.notra"]] <- purrr::map(
...
names(finher_her2[["inter.chemo.notra"]]) <- c("RFS", "DDFS", "OS")
...
finher_her2[["inter.chemo.tra"]] <- purrr::map(
...
names(finher_her2[["inter.chemo.tra"]]) <- c("RFS", "DDFS", "OS")
...
# >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
finher_her2[["inter.tra"]] <- purrr::map(
...
names(finher_her2[["inter.tra"]]) <- c("RFS", "DDFS", "OS")
...
finher_her2[["inter.tra.dtx"]] <- purrr::map(
...
names(finher_her2[["inter.tra.dtx"]]) <- c("RFS", "DDFS", "OS")
...
finher_her2[["inter.tra.nvb"]] <- purrr::map(
...
names(finher_her2[["inter.tra.nvb"]]) <- c("RFS", "DDFS", "OS")
...
ddfs[["prog"]] <- summarize_her2(x = finher_her2$prog$DDFS, prog = T)
ddfs[["inter.chemo"]] <- summarize_her2(x = finher_her2$inter.chemo$DDFS, prog = F)
ddfs[["inter.chemo.notra"]] <- summarize_her2(x = finher_her2$inter.chemo.notra$DDFS, prog = F)
ddfs[["inter.chemo.tra"]] <- summarize_her2(x = finher_her2$inter.chemo.tra$DDFS, prog = F)
ddfs[["inter.tra"]] <- summarize_her2(x = finher_her2$inter.tra$DDFS, prog = F)
ddfs[["inter.tra.dtx"]] <- summarize_her2(x = finher_her2$inter.tra.dtx$DDFS, prog = F)
ddfs[["inter.tra.nvb"]] <- summarize_her2(x = finher_her2$inter.tra.nvb$DDFS, prog = F)

write_xlsx(ddfs, path = str_c(out_tables,"finher_her2_ddfs_summary.xlsx"))



rfs <- list()

rfs[["prog"]] <- summarize_her2(x = finher_her2$prog$RFS, prog = T)
rfs[["inter.chemo"]] <- summarize_her2(x = finher_her2$inter.chemo$RFS, prog = F)
rfs[["inter.chemo.notra"]] <- summarize_her2(x = finher_her2$inter.chemo.notra$RFS, prog = F)
rfs[["inter.chemo.tra"]] <- summarize_her2(x = finher_her2$inter.chemo.tra$RFS, prog = F)
rfs[["inter.tra"]] <- summarize_her2(x = finher_her2$inter.tra$RFS, prog = F)
rfs[["inter.tra.dtx"]] <- summarize_her2(x = finher_her2$inter.tra.dtx$RFS, prog = F)
rfs[["inter.tra.nvb"]] <- summarize_her2(x = finher_her2$inter.tra.nvb$RFS, prog = F)

write_xlsx(rfs, path = str_c(out_tables,"finher_her2_rfs_summary.xlsx"))
...
os[["prog"]] <- summarize_her2(x = finher_her2$prog$OS, prog = T)
os[["inter.chemo"]] <- summarize_her2(x = finher_her2$inter.chemo$OS, prog = F)
os[["inter.chemo.notra"]] <- summarize_her2(x = finher_her2$inter.chemo.notra$OS, prog = F)
os[["inter.chemo.tra"]] <- summarize_her2(x = finher_her2$inter.chemo.tra$OS, prog = F)
os[["inter.tra"]] <- summarize_her2(x = finher_her2$inter.tra$OS, prog = F)
os[["inter.tra.dtx"]] <- summarize_her2(x = finher_her2$inter.tra.dtx$OS, prog = F)
os[["inter.tra.nvb"]] <- summarize_her2(x = finher_her2$inter.tra.nvb$OS, prog = F)

write_xlsx(os, path = str_c(out_tables,"finher_her2_os_summary.xlsx"))
